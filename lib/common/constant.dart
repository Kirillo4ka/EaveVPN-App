...
const appName = 'EaveVPN';
const appHelperService = 'EaveVPNHelperService';
const coreManifestName = 'manifest.json';
const coreName = 'clash.meta';
const browserUa =
    'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36';
const packageName = 'com.kirillo4ka.eavevpn';
final unixSocketPath = '/tmp/EaveVPNSocket_${Random().nextInt(10000)}.sock';
final windowsPipeName = '\\\\.\\pipe\\EaveVPNCore_${_randomPipeId()}';
...
const repository = 'Kirillo4ka/EaveVPN';
